    ...
    <section className="py-24 md:py-32 px-6 md:px-8" data-testid="section-testimonials">
      <div className="max-w-5xl mx-auto text-center space-y-12">
        <div className="space-y-4">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-foreground">Late-2025 results from real partners</h2>
            ...
            return (
              ...
              >
                <CardContent className="flex flex-col gap-6 p-8">
                  <p className="text-base text-foreground/90 leading-relaxed">“{testimonial.quote}”</p>
